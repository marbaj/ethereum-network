...
class Contract {
   ...
   * @param {*} gas 
   */
  constructor (contractAddress, ABI, address, gas = '410000') {
  ...
  async withdraw (methodName, from) {
  
    return await this._contract.methods[methodName]().send({ from: from, gas: 200000 });
  };
};
